...
[A_ClassifyA, A_ClassifyB] = get_error(n_a, KNN(samples_a, samples_b, samples_a(:,1), samples_a(:,2), 5), @(d) d < 0);
[B_ClassifyB, B_ClassifyA] = get_error(n_b, KNN(samples_a, samples_b, samples_b(:,1), samples_b(:,2), 5), @(d) d > 0);
